...
parser.add_argument('--config', type=str, default='DMFN/configs/celeba-hq-regular_list.yaml', help="net configuration")
parser.add_argument('--output_folder', type=str, default='outputs/testresults', help="output image path")
parser.add_argument('--checkpoint', type=str, default='DMFN/outputs/celebahq-regular/checkpoints/latest_G.pth',
